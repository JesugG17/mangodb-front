    ...
    return (
        <div className='w-full h-[93%]'>
            ...
            <div className='flex flex-col justify-items-start p-[30px] bg-[#fcfcfc] w-full h-[95%] rounded shadow-lg'>
                <div>
                    <div className='w-full h-9 flex gap-5 items-center text-black'>
                        <span>ID:</span>
                        <input type="text" placeholder='1234' disabled className='w-40 h-9' />
                        <span>Tipo:</span>
                        <input type="text" placeholder='Calidad' disabled className='w-40 h-9' />
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button className="bg-[#98a75f] hover:bg-[#7a8a3b] text-white flex gap-1">
                                    <Box className="mr-2 h-4 w-4" />Entrada de Caja
                                </Button>
                            </DialogTrigger>
